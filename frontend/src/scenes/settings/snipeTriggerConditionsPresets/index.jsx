...
const SnipeTriggerConditionsPresets = () => {
    ...
    const handleDelete = (_id, description) => {
        ...
        if(window.confirm(`Are you sure you want to delete the preset ${_id} with description: \n '${description}'?`)) {
            let index = -1;
            const snipeTriggerConditionsClone = [...snipeTriggerConditions];
            ...
            if(index !== -1) {
                ...
                setSnipeTriggerConditions(snipeTriggerConditionsClone);
            }

            navigate(
                '/snipe-trigger-conditions-presets',
            );
        }
    }
    ...
    const handleClearPresets = () => {
        if(window.confirm(`ARE YOU SURE YOU WANT TO CLEAR BROWSER STORAGE FOR SNIPE TRIGGER CONDITIONS?\n\nTHIS WILL DELETE ALL PRESETS.`)) {
            setSnipeTriggerConditions([]);
            window.alert(`Storage for snipe trigger conditions reset back to defaults`);
    ...
    const columns = [
        ...
        {
            field: "estimateGas",
            headerName: "Estimate Gas",
            flex: 1,
        },
        {
            field: "detectHoneypot",
            headerName: "Use HP Detector",
            flex: 1,
        },
        {
            field: "useMaxOutputLimitFinder",
            headerName: "Use Limit Finder",
            flex: 1,
        },
        {
        ...
        {
            field: "useTriggerTransaction",
            headerName: "Use Trigger Txn",
            flex: 1,
        },
        {
            field: "usePersistentSpam",
            headerName: "Use Persistent Spam",
            flex: 1,
        },
        {
            field: "useTargetBlock",
            headerName: "Use Target Block",
            flex: 1,
        },
        {
            field: "useBlockTimestamp",
            headerName: "Use Block Timestamp",
            flex: 1,
        },
        {
            field: "fee",
    ...
    return (
        <Box m="20px">
            <Header title="SNIPE TRIGGER CONDITIONS PRESETS" subtitle="List of existing presets for Snipe Trigger Conditions"/>
...
export default SnipeTriggerConditionsPresets;
