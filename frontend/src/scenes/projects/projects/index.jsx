...
const Projects = () => {
    ...
    const handleEdit = (id) => {
        ...
        navigate(
            '/project',
            { state: { loadId: id, loadMode: 'edit', origin: 'projects' } }
        );
    }
    ...
    const handleDuplicate = (id) => {
        ...
        navigate(
            '/project',
            { state: { loadId: id, loadMode: 'duplicate', origin: 'projects' } }
        );
    }

    const handleClearPresets = () => {
        if(window.confirm(`ARE YOU SURE YOU WANT TO CLEAR BROWSER STORAGE FOR PROJECTS?\n\nTHIS WILL DELETE ALL PRESETS.`)) {
            setProjects([]);
            window.alert(`Storage for projects reset back to defaults`);
            navigate('/projects',);
        }
    }
